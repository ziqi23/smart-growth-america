...
async function accessPHP() {
    console.log(1)

    const formData = new FormData();
    formData.append(action, "get_service_account_access_token");

    const url = "/wp-admin/admin-ajax.php?action=get_service_account_access_token";
